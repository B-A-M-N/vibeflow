...
def build_registry():
    registry = {
        "tools": {
            ...
            "web_fetch": {"source": BUILTIN_TOOL_SOURCE, "class": "WebFetch", "available": True, "aliases": ["WebFetch"]},
            "web_search": {"source": BUILTIN_TOOL_SOURCE, "class": "WebSearch", "available": True, "aliases": ["WebSearch"]},
        },
        "middleware": {
